...
router.post("/password_reset", (req, res, next) => {
    ...
    function(token, done) {
        ...
        User.findOne({ email: req.body.email }, (err, user) => {
            if (err) throw err;
        if (!user) {
            req.flash("error", "That Grateful wall account doesn't exist.");
    ...
    function(token, user, done) {
        ...
        let mailOptions = {
            from: "dookwhipsers@gmail.com",
            to: user.email,
            subject: "Reset your Gratefulwall Password",
...
router.post("/reset/:token", (req, res) => {
    ...
    function(user, done) {
        ...
        let mailOptions = {
            from: "dookwhipsers@gmail.com",
            to: user.email,
            subject: "Your grateful wall Password has been changed",
            text: "Hi " + user.firstName + ",\n\n" +
